...
/**
 * Created by hunain on 4/13/2018.
 */
...
public class MarkerAnimation {
    ...
    public MarkerAnimation(List<LatLng> points){
        this.points = points;
    }
            ...
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    try {
                        ...
                        LatLng newPosition = new LatLng((v * endPosition.latitude + (1-v) * startPosition.latitude),(v * endPosition.longitude + (1-v) * startPosition.longitude));
